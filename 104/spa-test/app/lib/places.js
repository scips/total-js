...
function lookupPlaces(lat, lng, callback) {
  ...
  if (dontLookup) {
    localStore.all(function(savedPOIs) {
      ...
      callback([{
        id: '42',
        name: 'Le Mont Liban',
        vicinity: '42 Boulevard Batignolles',
        distance: 65,
        duration: 49,
        key: Date.now() - _.random(0, 60) * 60000
      }, {
        id: '43',
        name: 'La Raymondine',
        vicinity: '42 Boulevard Batignolles',
        ...
        id: '44',
        name: 'Batignolles Express',
        vicinity: '32 Rue Batignolles',
        distance: 80,
        duration: 60,
        key: Date.now() - _.random(0, 60) * 60000
      }, {
        ...
        vicinity: '31 Boulevard Batignolles',
        distance: 99,
        duration: 68,
        key: Date.now() - _.random(0, 60) * 60000
      }, {
        id: '46',
        name: 'AGD',
        vicinity: '36 Boulevard Batignolles',
        distance: 99,
        duration: 68,
        key: Date.now() - _.random(0, 60) * 60000
      }, {
        id: '47',
        name: 'Le Paris Rome',
        vicinity: '60 Boulevard Batignolles',
        distance: 103,
        duration: 88,
        key: Date.now() - _.random(0, 60) * 60000
      }, {
        ...
        vicinity: '37 Avenue Clichy',
        distance: 108,
        duration: 92,
        key: Date.now() - _.random(0, 60) * 60000
      }, {
        id: '49',
        name: 'La Boutique de Camille',
        vicinity: '33 Boulevard Batignolles',
        distance: 126,
        duration: 115,
        key: Date.now() - _.random(0, 60) * 60000
      }, {
        id: '50',
        name: 'Fédération de la Boucherie',
        vicinity: '23 Rue Clapeyron',
        distance: 127,
        duration: 116,
        key: Date.now() - _.random(0, 60) * 60000
      }]);
  ...
  placesService.search({
    ...
    var dests = $.map(result, function(p) {
    ...
    distanceService.getDistanceMatrix({
      ...
      for (var index = 0, l = result.length; index < l; ++index) {
        var item = result[index],
          dist = distances.rows[0].elements[index];
        result[index] = {
          id: item.id,
          icon: item.icon,
          name: item.name,
